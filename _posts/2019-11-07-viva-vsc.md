...
이는 VS Code에 관리자 권한을 부여하지 않았기 때문에 새기느다. 탐색기에서 해당 소프트웨어 실행 파일로 이동 후 다음과 같이 VS Code에 관리자 권한을 부여하고 다시 실행하면 잘 설치된다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTk1MTkzMDQ5LC00ODY0NDgyNDYsLTU4Mz
