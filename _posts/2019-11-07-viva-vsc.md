...
Jupypter Notebook을 웹 브라우저에서 실행할 때 통상적인 IDE처럼 왼쪽에 코드, 오른쪽에 결과창이 있었으면 좋겠다는 생각을 해봤을 것이다. VS Code가 이를 구현해준다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NzA4MTM4NDQsLTQ4NjQ0ODI0NiwtNT
