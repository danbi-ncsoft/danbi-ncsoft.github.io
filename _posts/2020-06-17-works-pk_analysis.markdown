...
어쨌든 이런 숱한 논란에도 불구하고  **PK가 유저의 게임 활동에 어떤 영향을 미치는지 정량적이고 인과적으로 분석한 자료는 거의 찾기 힘듭니다.**  제 생각에 가장 큰 이유는 이 주제가 (분석을 수행할 가장 좋은 조건을 갖춘) 게임 회사 입장에서는 공개적으로 논의되기에 다소 불편한 주제라는 점 때문입니다. 하지만 자극적인 논쟁을 걷어내고 분석적인 관점으로만 본다면 흥미로울 뿐 아니라 실제 사회에서는 분석하기 힘든 사회학적인 현상을 풍부한 데이터를 통해 확인해 볼 수 있는 좋은 주제라 생각합니다. 
...
않기 때문에 [https://www.r-bloggers.com/probitlogit-marginal-effects-in-r/](https://www.r-bloggers.com/probitlogit-marginal-effects-in-r/) 를 참고하여 아래와 같은 함수를 만들었습니다.
    ...
    # 로지스틱 회귀 계수의 로그 오즈비 대신 marginal effect 를 구함 
...
<그림 8> 로지스틱 회귀 분석 결과 시각화 - PK 경험은 이탈율을 약 7% 포인트 낮추는 효과가 있으며, 95% 신뢰 구간 내에서 통게적으로 유의합니다. 
</p>
