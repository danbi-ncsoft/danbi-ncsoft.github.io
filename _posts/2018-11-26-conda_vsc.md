...
다음으로 VSC에서 Extension을 하나 깔아주자. View 메뉴에서 Extensions를 선택한다. (또는 창 맨 왼쪽의 아이콘에서 맨 아래 네모난 녀석을 클릭한다. 
<br>
<p align="center"><kbd>
<img src="/assets/etc/conda_vsc/python_extention.PNG" style="width:5in"> 
</kbd></p>
<br>
이 익스텐션은 날이 갈수록 좋아지고 있다. 기능 업데이트 사항은 수시로 점검하기를 권한다. 이 녀석이 VSC로 Python을 IDE처럼 쓸 수 있게 만들어 주는 녀석이다. 우선, IDE처럼 만들기 위해서 코드의 결과를 보는 창을 VSC에 띄워보자. 
...
<br>
<p align="center"><kbd>
<img src="/assets/etc/conda_vsc/pylint.png" style="width:5in"> 
</kbd></p>
<br>
...
<br>
<p align="center"><kbd>
<img src="/assets/etc/conda_vsc/vsc_1.png" style="width:7in">
</kbd></p>
<br>
...
<br>
<p align="center"><kbd>
<img src="/assets/etc/conda_vsc/vsc_3.png" style="width:5in"> 
</kbd></p>
<br>

매직 코멘트 `#%%`이 없는 `.py` 파일을 통으로 실행하고 싶다면? Command Palette (**View -> Command Palette**)를 선택하고, 명령창에 **Run Current File in Python Interactive window** 를 넣.
...
```cmd
"terminal.integrated.shellArgs.windows": ["%windir%\System32\cmd.exe" "/K", "C:\\ProgramData\\Miniconda3\\Scripts\\activate.bat C:\\ProgramData\\Miniconda3"
]
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMxODM0Njg0MSwyNjUyODkzODIsMTM0Mz
g3NzYxMywtMTM3OTEwNTM2MiwxMzY3MzU1MDc3LDIzNzY2OTMw
MywtMTQwNTcyMzYyMiwxNzk0NzgzNCwxNDY0NDY0MjI1LDc2OD
E2MjQ4NywxMjcyNTk2OTI5LDc2ODE2MjQ4Nyw3NjgxNjI0ODcs
LTcxODY5NDg3NSwxNTQxMjI5NzkwLDg3NTk0MDA2MiwtMjA1Mj
E0MDAyNCwtMTIxMjA1MzYxMiwxNDM1MzMwMCwyMDgxMDUwMTY4
XX0=
-->