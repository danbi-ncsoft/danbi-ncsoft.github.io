...
이 글을 위해서 새로 깔린 윈도우에서 위의 환경을 테스트해 봤다. 다 괜찮았는데 Jupyter notebook이 없다는 메시지가 뜨기도 하더라. 이때는 File &rarr; Preferences &rarr; Extensions로 가서 확장 팩을 깔아 주자. 옆에 뜬 검색창에 Python이라고 치면 설치 가능한 VSC 확장팩들이 뜬다. Windows 10에서 "Python Extension Pack"을 깔아서 문제가 해결되었다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU2MDk0MjkyNywtMTQwNTcyMzYyMiwxNz
