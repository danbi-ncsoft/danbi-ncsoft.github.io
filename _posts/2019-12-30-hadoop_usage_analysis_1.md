...
<그림 5> 시간대 별, 큐 별 자원 사용 효율 그래프
 ...
 지금까지 데이터 분석을 통한 하둡 시스템 개선 프로젝트의 목적과 그 중 하나의 주제인 큐별 자원 할당 비율 최적화 분석 내용을 살펴보셨습니다. 해당 내용이 실제 적용되었을 때 시스템이 얼마나 개선되었는지에 대한 검증 내용과, 시스템 개선을 위한 두번째 주제인 데이터 웨어하우스 테이블 구조 최적화의 내용은 다음 포스트([하둡 시스템 개선을 위한 테이터 분석 #2](<https://danbi-ncsoft.github.io/study/2019/12/30/hadoop_usage_analysis_2.html>))에서 찾아 뵙겠습니다.
