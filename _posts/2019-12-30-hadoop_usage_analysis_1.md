...
위 식에서 $$f_{k,i}(q)$$는 큐$$q$$에 대해서 정책 $$k$$를 적용했을 때 $$i$$시간대에 계산된 자원 사용 효율 지표를 의미합니다. 즉, 위 식은 모든 시간대 모든 큐에 대해서 자원 사용 효율 지표와 1 사이의 차이의 총합이 최소가 되는 정책$$k$$를 찾는 최적화 수식을 의미합니다.
