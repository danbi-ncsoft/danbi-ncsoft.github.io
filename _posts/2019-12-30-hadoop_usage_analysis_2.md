...
앞선 포스팅([하둡 시스템 개선을 위한 데이터 분석 #1](<https://danbi-ncsoft.github.io/study/2019/12/30/hadoop_usage_analysis_1.html>))에서 데이터 분석을 통한 하둡 시스템 개선 프로젝트의목적과 그 첫번째 주제인 capacity scheduler 최적화를 위한 큐별 자원 할당 비율 을 최적화하는 분석을 살펴보았습니다. 
